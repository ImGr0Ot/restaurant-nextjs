      ...
      <div className="mx-10">
        <div className="flex flex-col mx-auto lg:flex-row mt-24 mb-16 bg-white max-w-screen-lg rounded-lg shadow-2xl">
          ...
          <div className="flex flex-col gap-5 lg:flex-1 mb-10">
            ...
            <form action={submitLogin} className="flex flex-col gap-3">
              <input
                name="email"
                type="email"
                placeholder="Email"
              ...
              <button
                type="submit"
                className="w-20 mx-28 mb-4 mt-2 bg-green-500 rounded-lg p-2 text-white shadow-xl "
              >
                {isPending ? <PulseLoader color="white" size={8} /> : "Submit"}
              </button>
            </form>
            ...
            <p className="text-center">
              ...
              <button
                onClick={() => {
                  router.push("/register"), setLoading(true);
                }}
              ...
              >
                ...
                {loading ? (
                  <div className="flex items-center gap-2">
                    <h1>Redirecting</h1>
                    <PulseLoader color="#202625" size={8} />
                  </div>
                ) : (
                  "Register"
                )}
